...
//		gl.glRotatef(rotate, 0, 0, 1);
		...
		gl.glTranslatef(0,Height()*.49f,0);
	...
	public void drawRS(GL10 gl,float scalx,float scaly,float rotate,float _x,float _y) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
		...
		gl.glTranslatef(_x,_y,0);
//		gl.glScalef(M.ScreenWidth/M.ScreenHieght,1,0);
		gl.glRotatef(rotate, 0, 0, 1);
		gl.glScalef(scalx, scaly, 0);
//		gl.glTranslatef(-width()*.5f,0,0);
	...
	public void drawR(GL10 gl,float rotate,float _x,float _y) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
	...
	public void drawFilp(GL10 gl,float x, float y,float rotate)
    {
        gl.glPushMatrix();
        gl.glEnableClientState(GL10.GL_VERTEX_ARRAY);
        gl.glVertexPointer(3, GL10.GL_FLOAT, 0, mVerticesBuffer);
	...
	public void drawTransprent(GL10 gl,float x, float y, float t)
    {
        gl.glPushMatrix();
        gl.glEnableClientState(GL10.GL_VERTEX_ARRAY);
        gl.glVertexPointer(3, GL10.GL_FLOAT, 0, mVerticesBuffer);
...
//        gl.glTexEnvf(GL10.GL_TEXTURE_ENV, GL10.GL_TEXTURE_ENV_MODE, GL10.GL_REPLACE);
        if(!check2(mBitmap.getWidth())||!check2(mBitmap.getHeight()))
