...
public class M 
{
	public static final int ACHIV[] = {
		  R.string.achievement_sharp_shooter,
		  R.string.achievement_master_shooter,
		  R.string.achievement_macho,
		  R.string.achievement_perfect_shooter,
		  R.string.achievement_guru
	};
	public static final int ARCAD[] = {
		  R.string.leaderboard_20_bottle,
		  R.string.leaderboard_50_bottle,
		  R.string.leaderboard_100_bottle,
	};
	
	public static final int TIME[] = {
		  R.string.leaderboard_20_sec,
		  R.string.leaderboard_40_sec,
		  R.string.leaderboard_60_sec,
	};
	
	public static final byte Bottle = 13;
	public static final byte BALL = 7;
	...
	public static final byte GAMEARCARD = 4;
	public static final byte GAMEPAUSE = 5;
	public static final byte GAMETIME = 7;
