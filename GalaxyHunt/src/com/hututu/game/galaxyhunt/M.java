...
public class M 
{
	...
	public static final int Max_Plife = 124;
	public static int Plife = Max_Plife;
	public static Random mRand = new Random();
	public static final String score = "score";
	public static int GameScreen;
	public static final int GAMELOGO = 0,GAMEPAUSE = 1,GAMEMENU = 2,GAMEPLAY = 3,GAMEADD=50;
	public static final int GAMEHELP = 4,GAMEOVER  = 5,GAMEINFO = 6,GAMEHIGH = 7;
	...
	public static final String MY_AD_UNIT_ID = "ca-app-pub-3395412980708319/2750315388";	//AndroidMarket
	public static final String HOUSE_ADV_ID  = "ca-app-pub-3395412980708319/4227048587";	//AdHouse
	public static void loadSound(Context context)
	{
		try{
			...
			if(mpEffect==null)
				mpEffect = MediaPlayer.create(context, R.drawable.blast1);//
			
			if(mpEffect2==null)
				mpEffect2 = MediaPlayer.create(context, R.drawable.blast2);
			
			if(mpEffect3==null)
				mpEffect3 = MediaPlayer.create(context, R.drawable.blast3);//
			
			if(mpEffect4==null)
				mpEffect4 = MediaPlayer.create(context, R.drawable.blast4);//
			
			if(mpEffect5==null)
				mpEffect5 = MediaPlayer.create(context, R.drawable.electric);//
	...
	public static void sound1(Context context, int resource) {
		...
		try{
			...
			if(!mpEffect.isPlaying())
				...
				sound2(context,R.drawable.blast2);
		}catch(Exception e){}	
	}
	public static void sound2(Context context, int resource) {
		...
		try{
			...
			if(!mpEffect2.isPlaying() && setValue)
				...
				sound3Play(context,R.drawable.blast3);
		}catch(Exception e){}
	}
		...
		try{
			if (setValue) 
			{
				...
				if(!mpEffect3.isPlaying())
				{
					...
					sound4(context,R.drawable.blast4);
			}
		}catch(Exception e){}
	}
