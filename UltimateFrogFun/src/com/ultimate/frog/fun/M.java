...
public class M 
{
	public static final int ACHIV[] = {
		  R.string.achievement_smart_frog,
		  R.string.achievement_master_frog,
		  R.string.achievement_jump_frog,
		  R.string.achievement_fast_frog,
		  R.string.achievement_king_frog
	};
	
	
	
	public static float SPD = -.1f;
	public static float HGT = 0.5f;
	...
	public static final int GAMELOGO = 0 ,GAMESPLASH = 1,GAMEMENU = 3,GAMEHIGH=4,GAMEPLAY = 5;
	public static final int GAMEHELP   = 7,GAMEOVER = 8,GAMESURVIVAL = 9,GAMEPAUSE = 10,GAMEWIN = 11;
