...
public class M 
{
	public static final String DIR = "/face_maker";
...
//	
	public static final String MARKET 		= "http://slideme.org/user/roboticsapp";
	public static final String LINK 		= "market://details?id=";
	public static final String SHARELINK 	= "http://slideme.org/user/roboticsapp";
...
//	
	...
	public static final int GAMELOGO = 0 ,GAMETEXT = 1,GAMEMENU = 3,APPMAIN=4,GAMEPLAY = 5;
	public static final int GAMEHELP   = 7,GAMEOVER = 8,GAMEA = 9,GAMELEVEL = 10,GameSUB = 11;
...
//				sound3Play(GameRenderer.mContext,R.drawable.g3);
	...
	public static void sound3Play( int resource) {
		if(!setValue)
			 return;
		try{
			if (setValue) 
