...
//    boolean GameRenderer.mStart.mGR.SingUpadate = GameRenderer.mStart.getSharedPreferences("X", Start.MODE_PRIVATE).getBoolean("SingUpadate", false);
...
//        GameRenderer.mStart.mGR.SingUpadate = false;
        if (GameRenderer.mStart.mGR.SingUpadate) {
            ...
            debugLog("Not attempting to connect becase GameRenderer.mStart.mGR.SingUpadate=false");
    ...
    public void beginUserInitiatedSignIn() {
        ...
        GameRenderer.mStart.mGR.SingUpadate = true;
    ...
    public void setConnectOnStart(boolean connectOnStart) {
        debugLog("Forcing GameRenderer.mStart.mGR.SingUpadate=" + connectOnStart);
        GameRenderer.mStart.mGR.SingUpadate = connectOnStart;
    }
}
