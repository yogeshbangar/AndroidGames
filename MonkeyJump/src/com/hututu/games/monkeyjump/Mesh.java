...
//	private final float[] mRGBA = new float[] { 1.0f, 1.0f, 1.0f, 1.0f };
	...
	public void drawRotet(GL10 gl,float _x,float _y,float r,boolean isFullRotate) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
...
//		gl.glDisable(GL10.GL_CULL_FACE);
	...
	public void drawRTS(GL10 gl,float _x,float _y,float z,float ang,float r,float g,float b,float t) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
