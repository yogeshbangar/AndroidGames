...
public class M 
{
	...
	public static int ACHIV[]={
		R.string.achievement_runner,
		R.string.achievement_super_runner,
		R.string.achievement_master_runner,
		R.string.achievement_royal_monkey,
		R.string.achievement_king_monkey
	};
...
//	
	...
	public static final int GAMEBUY	= 6;
	...
	private static MediaPlayer mpBG1 = null,mpBG2 = null,mpBG3 = null,mpBG4 = null,mpBG5 = null,mpBG6 = null,mpBG7 = null;
...
//					sound4(context,R.drawable.g4);
	...
	public static void sound8Pause() {
		try {
			if (mpEffect8 == null || !setValue) {
				return;
			}
			if (mpEffect8.isPlaying() && setValue)
				mpEffect8.pause();
	...
	public static void sound17Pause() {
		if (!setValue)
			return;
		try {
			if (mpBG2 == null) {
	...
	public static void sound4Bonus(Context context,int opp,int counter){
		switch (opp) {
		case 2://Gilahari
			M.sound2(context, R.drawable.power_gilgari);
			break;
		case 3://Chidiya
			M.sound3(context, R.drawable.power_chidiay);
			break;
		case 4://Rokect
			M.sound4(context, R.drawable.power_rock);
			break;
		default://1 chakra
			M.sound5(context, R.drawable.power_sudarshan);
			break;
		}
	}

	public static void sound4Bstop(Context context, int opp, int counter) {
		switch (opp) {
		case 2:// Gilahari
			if (mpEffect2 != null) {
				mpEffect2.stop();
