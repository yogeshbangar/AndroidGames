...
//	private Handler handler2 = new Handler() {public void handleMessage(Message msg) {mStart.adHouse.setVisibility(msg.what);}};//AdHouse
	...
	void init() {
		try {
			...
			mTex_AboutTxt = add("aboutus_text.png");
...
//		mBgx = -.97f;
		for(mGuy.colNo =0;mGuy.colNo<mTile.length;mGuy.colNo++){
			for(int j=0;j<mL01.l1.length;j++){
				switch (Levelno) {
				case 13:
					mTile[mGuy.colNo].array[j] = mL13.l1[j][mGuy.colNo];
					break;
				case 12:
					mTile[mGuy.colNo].array[j] = mL12.l1[j][mGuy.colNo];
					break;
				case 11:
					mTile[mGuy.colNo].array[j] = mL11.l1[j][mGuy.colNo];
					break;
				case 10:
					mTile[mGuy.colNo].array[j] = mL10.l1[j][mGuy.colNo];
					break;
				case 9:
					mTile[mGuy.colNo].array[j] = mL09.l1[j][mGuy.colNo];
					break;
				case 8:
					mTile[mGuy.colNo].array[j] = mL08.l1[j][mGuy.colNo];
					break;
				case 7:
					mTile[mGuy.colNo].array[j] = mL07.l1[j][mGuy.colNo];
					break;
				case 6:
					mTile[mGuy.colNo].array[j] = mL06.l1[j][mGuy.colNo];
					break;
				case 5:
					mTile[mGuy.colNo].array[j] = mL05.l1[j][mGuy.colNo];
					break;
				case 4:
					mTile[mGuy.colNo].array[j] = mL04.l1[j][mGuy.colNo];
					break;
				case 3:
					mTile[mGuy.colNo].array[j] = mL03.l1[j][mGuy.colNo];
					break;
				case 2:
					mTile[mGuy.colNo].array[j] = mL02.l1[j][mGuy.colNo];
					break;
				case 1:
				default:
					mTile[mGuy.colNo].array[j] = mL01.l1[j][mGuy.colNo];
					break;
				}
