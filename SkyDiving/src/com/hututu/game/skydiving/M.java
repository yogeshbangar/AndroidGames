...
//	
	public static final float  MAXSPEED = .01f;
	public static float  SPEED = .01f;
	public static Random mRand = new Random();
	public static final String score = "score";
	public static int GameScreen;
	public static final int GAMELOGO = 0 ,GAMEADD = 1,GAMEMENU = 3,GAMEPLAY = 5;
	public static final int GAMEOVER = 8,GAMEA = 9,GAMELEVEL = 10,GAMEWIN = 11;
	public static final int GAMECONG = 12,GAMEPAUSE = 13;
...
//	private static MediaPlayer mp1 	= null;
	...
	public static final String HOUSE_ADV_ID  = "ca-app-pub-3395412980708319/7819643385";	//House Adv
	public static final String MY_AD_UNIT_ID = "ca-app-pub-3395412980708319/6342910182";//Sky Diving
...
//					sound4(context,R.drawable.g4);
	...
	public static void sound4(Context context, int resource) {
		...
		try{
			...
			if(!mpEffect4.isPlaying() && setValue)
				...
				sound5(context,R.drawable.parachute_opne);
		}catch(Exception e){}
	}
	public static void sound5(Context context, int resource) {
		...
		if(!mpEffect5.isPlaying() && setValue)
			...
			sound6(context,R.drawable.parachute_opne);
	...
	public static void sound6(Context context, int resource) {
		...
		if(!mpEffect6.isPlaying() && setValue)
			...
			sound12(context,R.drawable.parachute_opne);
		}catch(Exception e){}
	}
	...
	public static void sound8(Context context, int resource) {
		...
		if(!mpEffect8.isPlaying() && setValue)
			...
			sound9(context,R.drawable.puppet_score_power);
		}catch(Exception e){}
	}
	...
	public static void sound12(Context context, int resource) {
		...
		if(!mpEffect12.isPlaying() && setValue)
			...
			sound13(context,R.drawable.parachute_opne);
		}catch(Exception e){}
	}
	public static void sound13(Context context, int resource) {
		...
		if(!mpEffect13.isPlaying() && setValue)
			...
			sound14(context,R.drawable.parachute_opne);
		}catch(Exception e){}
	}
	public static void sound14(Context context, int resource) {
		...
		if(!mpEffect14.isPlaying() && setValue)
			...
			sound15(context,R.drawable.parachute_opne);
		}catch(Exception e){}
	}
