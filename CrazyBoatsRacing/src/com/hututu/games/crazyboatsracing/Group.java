...
public class Group extends Mesh 
{
	...
	float sx=.1f,sy=1;
	float ssx=.0f,ssy=0;
	public void setting(){float ud=.01f;switch (GameRenderer.mStart._keyCode) {case 1:ssy-=ud;break;case 2:ssy+=ud;break;case 3:ssx-=ud;break;case 4:ssx+=ud;break;}System.out.println(M.GameScreen+"~~~~~~~~~~~~~~~      "+ssx+"~~~~~~~~~~~~       "+ssy);}
...
//			DrawTransScal(gl, mGR.mTex_Road[0],0,0,1,mGR.mPlayer.mPower[0]?sx:1);
	...
	void Achivment()
	{
		...
		if (!mGR.addFree && mGR.ADScount % 5 == 0)
		{
