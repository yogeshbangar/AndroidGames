...
public class Mesh 
{
	...
	public void drawRotet(GL10 gl,float _x,float _y,float rotate,float scal) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
	...
	public void drawRotet1(GL10 gl,float _x,float _y,float rotate,float de) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
		...
		gl.glTranslatef(_x,_y,0);
		gl.glScalef((M.ScreenHieght/M.ScreenWidth)*1.5f,1.5f,0);
		gl.glRotatef(rotate, 0, 0, 1);
		gl.glTranslatef(width()*de,0,0);
