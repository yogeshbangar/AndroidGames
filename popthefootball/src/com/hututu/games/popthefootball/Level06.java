...
public class Level06 {
	...
	SimplePlane mTex_BG,mTex_Fruit[],mTex_button[],mTex_Bulti[],mTex_Putti[];//,mTex_PSplash[];
	GameRenderer mGR;
	public Level06(GameRenderer _GameRenderer)
	{
		mGR = _GameRenderer;
		mTex_BG			= GameRenderer.add("l6/l6.png");
		
		mTex_Putti		= new SimplePlane[2];
		mTex_Putti[0]	= GameRenderer.add("l6/patti1.png");
		mTex_Putti[1]	= GameRenderer.add("l6/patti2.png");
		mTex_Bulti		= new SimplePlane[2];
		mTex_Bulti[0]	= GameRenderer.add("l6/balti.png");
		mTex_Bulti[1]	= GameRenderer.add("l6/balti0.png");
...
//		
		Group.DrawTextureS(gl, mTex_Bulti[1],-.67f,-.23f,1.3f);
		Group.DrawTexture(gl, mTex_Putti[move?counter2%2:0],.36f,.42f);
		for(int i=0;i<mFruit.length;i++)
		{
			Group.DrawTexture(gl, mTex_Fruit[mFruit[i].n],mFruit[i].x,mFruit[i].y);
		}
		Group.DrawTextureS(gl, mTex_Bulti[0],-.67f,-.23f,1.3f);
