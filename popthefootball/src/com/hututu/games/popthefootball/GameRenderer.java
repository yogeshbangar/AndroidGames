...
//	byte Stars1[];
	...
	SimplePlane mTex_PauseB,/*mTex_Time_box,*/mTex_Star[],mTex_Trans;
...
//			mTex_HelpB		= add("common/help_button.png");
			mTex_PauseB		= add("common/paused.png");
			...
			mLOne			= new Level01(this);
			mLTwo			= new Level02(this);
			mLTree			= new Level03(this);
			mLFour			= new Level04(this);
			mLFive			= new Level05(this);
			mLsix			= new Level06(this);
			mLNine			= new Level09(this);
			mLTen			= new Level10(this);
			mLEleven		= new Level11(this);
			mLTwelve		= new Level12(this);
			mLThirteen		= new Level13(this);
