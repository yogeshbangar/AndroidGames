...
public class MainActivity {
	...
	static final String HTT_TENCLOCKS 		= "nine_starts"; 
...
//			R.drawable.gas2, R.drawable.gas3, R.drawable.gas4 };
	...
	public void onCreate() {
		 ...
		 */
		String base64EncodedPublicKey = "";
	...
	IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener = new IabHelper.OnIabPurchaseFinishedListener() {
		public void onIabPurchaseFinished(IabResult result, Purchase purchase) {
			System.out.println(TAG+"    Purchase finished: " + result + ", purchase: " + purchase);
			if (result.isFailure()) {
...
//				complain("Error purchasing. Authenticity verification failed.");
			...
			System.out.println(TAG+" ~Successful~ "+ GameRenderer.mStart.mGR.Clock+
					GameRenderer.mStart.mGR.BuyStar + GameRenderer.mStart.addFree +purchase.getSku());
			if (purchase.getSku().equals(HTT_REMOVE_ADS)) {
				...
				GameRenderer.mStart.mGR.BuyStar += 9;
