...
//	com.airpush.android.Airpush airpush;
	GameRenderer mGR = null;
	private InterstitialAd interstitialAd;
	private static Context CONTEXT;
	void callAdds()
	{
//		adView = new AdView(this, AdSize.IAB_BANNER, M.MY_AD_UNIT_ID);
...
//	    	editor.putInt("Stars"+i, mGR.Stars[i]);
	    ...
	    }*/
	    {
	    	...
	    	editor.putFloat("N9bgmove", mGR.mLNine.bgmove);
...
//	    		editor.putFloat(i+"T10cx", mGR.mLTen.cx[i]);
	...
	void resume()
	{
	    ...
	    }*/
	    {
	    	...
	    	mGR.mLNine.bgmove = prefs.getFloat("N9bgmove", 0);
