...
//	
	...
	public static final float CSPEED = -.03f;
	public static Random mRand = new Random();
	public static final String score = "score";
	public static int GameScreen;
	public static final int GAMELOGO = 0,GAMEADD  = 1,GAMECONG = 2,GAMEMENU  = 3,GAMESHOP  = 4,GAMEPLAY = 5,GAMEMAP   = 6;;
	public static final int GAMEINFO = 7,GAMEHELP = 8,GAMEOVER = 9,GAMEABOUT =10,GAMELEVEL =11,GAMEWIN  =12,GAMEPAUSE =13;
//	public static final int GAMELOAD =14;
	public static final String HOUSE_ADV_ID  = "ca-app-pub-3395412980708319/1145718581";	//AdHouse
...
//					sound4(context,R.drawable.g4);
	...
	public static void sound6(Context context, int resource) {
		...
		if(!mpEffect6.isPlaying() && setValue)
			...
			sound7(context,R.drawable.coin);
		}catch(Exception e){}
	}
	public static void sound7(Context context, int resource) {
		...
		if(!mpEffect7.isPlaying() && setValue)
			...
			sound8(context,R.drawable.coin);
		}catch(Exception e){}
	}
	public static void sound8(Context context, int resource) {
		...
		if(!mpEffect8.isPlaying() && setValue)
			...
			sound9(context,R.drawable.coin);
		}catch(Exception e){}
	}
