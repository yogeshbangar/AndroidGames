...
public class MainActivity {
	...
	static final String SKU_50000 = "50000coins";// "gas";
	static final String SKU_150000 = "freecoin_u";// "infinite_gas"; // SKU for
													// our subscription
													// (infinite gas)
...
*/
	...
	public void onBuyGoldButtonClicked(View arg0) {
		...
		mHelper.launchPurchaseFlow(GameRenderer.mStart, SKU_350000, RC_REQUEST,
	...
	public void onBuyGasButtonClicked(View arg0) {
		 ...
		 */
		String payload = "";
		mHelper.launchPurchaseFlow(GameRenderer.mStart, SKU_150000, RC_REQUEST,
				mPurchaseFinishedListener, payload);
	}
	...
	IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener = new IabHelper.OnIabPurchaseFinishedListener() {
		public void onIabPurchaseFinished(IabResult result, Purchase purchase) {
			...
			System.out.println(TAG+ GameRenderer.mStart.mGR.coin
					+ "  Purchase successful~~~~~~~~~~~~~~~~~~~~~~~~~~~"
					+ purchase.getSku());

			if (purchase.getSku().equals(SKU_350000)) {
				GameRenderer.mStart.mGR.coin += 50000;
//				alert("Thank you for subscribing to infinite gas! SKU_350000");
				...
				GameRenderer.mStart.mGR.coin += 150000;
//				alert("Thank you for subscribing to infinite gas! SKU_150000");
				...
				GameRenderer.mStart.mGR.coin += 10000;
...
//				alert("Thank you for upgrading to premium! SKU_10000");
				...
				// updateUi();
				// setWaitScreen(false);
			} else if (purchase.getSku().equals(SKU_50000)) {
				GameRenderer.mStart.mGR.coin += 50000;
...
//				alert("Thank you for subscribing to infinite gas! SKU_50000");
			...
			total = GameRenderer.mStart.mGR.coin;
			System.out.println(TAG+ GameRenderer.mStart.mGR.coin
