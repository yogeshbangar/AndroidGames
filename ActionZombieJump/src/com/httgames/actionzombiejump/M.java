...
public class M {
	...
	public static final int ACHIV[] = {
		  ...
		  R.string.achievement_elevater,
		  R.string.achievement_master,
		  R.string.achievement_magnate
	};
	...
	public static void sound3lay(int resource) {
		if (!setValue)
			return;
		try {
			if (setValue) {
	...
	static void ranSound(){
		switch (M.mRand.nextInt(3)) {
		case 1:
			M.sound4(R.drawable.z1);
			break;
		case 2:
			M.sound5(R.drawable.z2);
			break;
		default:
			M.sound6(R.drawable.z3);
			break;
		}
	}
}
