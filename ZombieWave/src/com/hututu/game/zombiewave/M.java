...
public class M {
	...
	// "samsungapps://ProductDetail/com.hututu.game.galaxyhunt";
	// public static final String LINK = "samsungapps://ProductDetail/";
	// public static final String SHARELINK =
	// "samsungapps://ProductDetail/com.hututu.game.galaxyhunt";
	//
	// public static final String MARKET =
	// "http://slideme.org/user/hututugames";
	// public static final String LINK = "market://details?id=";
	// public static final String SHARELINK =
	// "http://slideme.org/user/hututugames";
	...
	// public static final String MARKET =
	// "http://www.amazon.com/gp/mas/dl/android?p=com.hututu.game.shootthebottle&showAll=1";
	// public static final String SHARELINK =
	// "http://www.amazon.com/gp/mas/dl/android?p=com.hututu.game.shootthebottle&showAll=1";
	//
	...
	public static final int GAMEMAP = 3;
	public static final int GAMESHOP = 4;
	public static final int GAMEPLAY = 5;
	public static final int GAMEOVER = 6;
	public static final int GAMEWIN = 7;
	public static final int GAMECONG = 8;
	public static final int GAMEPRMO = 9;
	public static final int GAMEABOUT = 10;
	public static final int GAMESTORY = 11;
	...
	private static MediaPlayer mpBG1 = null, mpBG2 = null, mpBG3 = null,
			mpBG4 = null, mpBG5 = null;
	...
	static void Box(Context mContext) {
		switch (mRand.nextInt(5)) {
		case 0:
			M.sound1(mContext, R.drawable.hard_crash1);
			break;
		case 1:
			M.sound2(mContext, R.drawable.hard_crash2);
			break;
		case 2:
			M.sound3(mContext, R.drawable.hard_crash3);
			break;
		case 3:
			M.sound4(mContext, R.drawable.hard_crash4);
			break;
		case 4:
			M.sound5(mContext, R.drawable.hard_crash5);
			break;
		}
	}

	static void Zombie(Context mContext) {
		switch (mRand.nextInt(5)) {
		case 0:
			M.sound11(mContext, R.drawable.zombie1);
			break;
		case 1:
			M.sound12(mContext, R.drawable.zombie2);
			break;
		case 2:
			M.sound13(mContext, R.drawable.zombie3);
			break;
		case 3:
			M.sound14(mContext, R.drawable.zombie4);
			break;
		case 4:
			M.sound15(mContext, R.drawable.zombie5);
			break;
		}
	}
