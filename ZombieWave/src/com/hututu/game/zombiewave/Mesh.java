...
//		gl.glRotatef(rotate, 0, 0, 1);
	...
	public void drawfullRotet(GL10 gl,float _x,float _y,float r,float pos,float scal) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
	...
	public void drawRGB(GL10 gl,float x, float y, float z,float r,float g,float b,float t)
    {
        gl.glPushMatrix();
        gl.glEnableClientState(GL10.GL_VERTEX_ARRAY);
        gl.glVertexPointer(3, GL10.GL_FLOAT, 0, mVerticesBuffer);
	...
	public void drawBlack(GL10 gl,float x, float y, float t, float sx, float sy)
    {
        gl.glPushMatrix();
        gl.glEnableClientState(GL10.GL_VERTEX_ARRAY);
        gl.glVertexPointer(3, GL10.GL_FLOAT, 0, mVerticesBuffer);
