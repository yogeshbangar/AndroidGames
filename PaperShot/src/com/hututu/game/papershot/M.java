...
public class M 
{
	...
	public static final String PAPERSHOOT 	= "Paper Shoot";
	public static final String VER 			= "V 1.0";
	public static final String DEVELOPED 	= "Developed by";
	public static final String HUTUTU	 	= "Hututu Games";
	...
	public static final String KITCHEN 		= "Road";
	public static final String LOUNGE	 	= "Lounge";
	
	public static final String HS	 		= "High Score";
	public static final String SUBMIT 		= "Submit Score";
	public static final String GLOBLE	 	= "Global Score";
	
	public static final String PAUSE		= "Game Pause";
	public static final String RESUME	 	= "Resume";
	public static final String RETRY	 	= "Retry";
	public static final String MAINMANU	 	= "Main Menu";
	...
	public static final int GAMELOGO = 0 ,GAMEMENU = 2,GAMEBG = 3,GAMEHIGH=4,GAMEPLAY = 5,GAMEADD=50;
	public static final int GAMEHELP = 7,GAMEOVER = 8,GAMEABOUT = 9,GAMEPAUSE = 10,GAMEWIN = 11;
	public static float mAir = 0;
	...
	public static final String MY_AD_UNIT_ID = "ca-app-pub-3395412980708319/8517647389";	//AndroidMarket
	public static final String HOUSE_ADV_ID  = "ca-app-pub-3395412980708319/9994380586";	//AdHouse
...
//				mp = MediaPlayer.create(context, R.drawable.bgsound);//
			...
			if(mpEffect==null)
				mpEffect = MediaPlayer.create(context, R.drawable.foot);//
			
			if(mpEffect2==null)
				mpEffect2 = MediaPlayer.create(context, R.drawable.plastic);
			
			if(mpEffect3==null)
				mpEffect3 = MediaPlayer.create(context, R.drawable.steel);//
//	
