...
public class M 
{
	public static final int ACHIV[] = {
		  R.string.achievement_classic_mine_hero,
		  R.string.achievement_sharp_mine_hero,
		  R.string.achievement_faller_mine_hero,
		  R.string.achievement_master_mine_hero,
		  R.string.achievement_king_mine_hero
	};
...
//	
	...
	public static final byte GAMEHELP = 3;
	public static final byte GAMEOVER = 4;
	public static final byte GAMEBUY = 5;
	public static final byte GAMEABOUT = 6;
	public static final byte GAMESHOP = 7;
	public static final byte GAMEPAUSE = 8;
