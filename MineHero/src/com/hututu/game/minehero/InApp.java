...
//	static final String SKU_50000 ="four";//Get 100000 Coin (four)
	...
	public void onCreate() {
		String base64EncodedPublicKey = "";
...
//				complain("Error purchasing: " + result);
			...
			if (purchase.getSku().equals(SKU_10000)) {
				GameRenderer.mStart.mGR.mCoin+=1000;
				alert("Success");
			}
			if (purchase.getSku().equals(SKU_20000)) {
				GameRenderer.mStart.mGR.mCoin+=3000;
				alert("Success");
			}
			if (purchase.getSku().equals(SKU_30000)) {
				GameRenderer.mStart.mGR.mCoin+=7000;
				alert("Success");
			}
			if (purchase.getSku().equals(SKU_40000)) {
				GameRenderer.mStart.mGR.mCoin+=15000;
				alert("Success");
			}
