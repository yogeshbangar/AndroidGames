...
public class M 
{
	public static int achiment[] = {
		R.string.achievement_perfect_shooter,
		R.string.achievement_master_shooter,
		R.string.achievement_expert_shooter,
		R.string.achievement_specialist_shooter,
	...
	public static final int GAMEADD	= 4;
	...
	public static final int GAMEJOIN	=10;
	public static final int GAMEEXIT	=11;
	...
	public static final String MY_AD_UNIT_ID = "ca-app-pub-3395412980708319/1179084586";	//AndroidMarket
	public static final String INTERSTITIAL_ID  = "ca-app-pub-3395412980708319/2655817788";	//AdHouse
