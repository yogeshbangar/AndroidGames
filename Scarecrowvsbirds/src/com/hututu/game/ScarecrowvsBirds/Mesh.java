...
//	private final float[] mRGBA = new float[] { 1.0f, 1.0f, 1.0f, 1.0f };
	...
	public void drawScal(GL10 gl,float x,float y,float sx, float sy) 
	{
		...
		gl.glScalef(sx,sy,0);
//		gl.glScalef((M.ScreenHieght/M.ScreenWidth)*sx,sy,0);
	...
	public void drawRotet(GL10 gl,float rotateX,float rotateY,float rotateZ,float _x,float _y) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
		...
		gl.glScalef(M.ScreenHieght/M.ScreenWidth,1,0);
	...
	public void drawRotetAtPoint(GL10 gl,float rotate,float rx,float ry,float _x,float _y) 
	 {
		 gl.glPushMatrix();
		 gl.glEnableClientState(GL10.GL_VERTEX_ARRAY);
		 gl.glVertexPointer(3, GL10.GL_FLOAT, 0, mVerticesBuffer);
	...
	public void drawRotetAtPointS(GL10 gl,float rotate,float rx,float ry,float _x,float _y,float Scalx,float Scaly) 
	 {
		 gl.glPushMatrix();
		 gl.glEnableClientState(GL10.GL_VERTEX_ARRAY);
		 gl.glVertexPointer(3, GL10.GL_FLOAT, 0, mVerticesBuffer);
	...
	public void drawFilp(GL10 gl,float x, float y)
    {
        gl.glPushMatrix();
        gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
...
//      gl.glBlendFunc(GL10.GL_SRC_ALPHA, GL10.GL_ONE_MINUS_SRC_ALPHA);
	...
	public void drawTransprent(GL10 gl,float x, float y)
    {
        gl.glPushMatrix();
        gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
...
//      gl.glBlendFunc(GL10.GL_SRC_ALPHA, GL10.GL_ONE_MINUS_SRC_ALPHA);
	...
	public void drawRST(GL10 gl,float x, float y,float ang,float scal,float trans)
    {
        gl.glPushMatrix();
        gl.glEnableClientState(GL10.GL_VERTEX_ARRAY);
        gl.glVertexPointer(3, GL10.GL_FLOAT, 0, mVerticesBuffer);
        ...
        if (mTextureId != -1 && mTextureBuffer != null) {
            ...
            gl.glTexCoordPointer(2, GL10.GL_FLOAT, 0, mTextureBuffer);
            gl.glBindTexture(GL10.GL_TEXTURE_2D, mTextureId);
            gl.glColor4f(trans,trans,trans,trans);
        }
        gl.glTranslatef(x, y, 0);
        gl.glScalef((M.ScreenHieght/M.ScreenWidth),1,0);
        gl.glRotatef(ang,0,0,-1);
		gl.glScalef(scal,scal,0);
        gl.glDrawElements(GL10.GL_TRIANGLES, mNumOfIndices,GL10.GL_UNSIGNED_SHORT, mIndicesBuffer);
        if (mTextureId != -1 && mTextureBuffer != null) {
            gl.glDisableClientState(GL10.GL_TEXTURE_COORD_ARRAY);
        }
...
//        gl.glTexEnvf(GL10.GL_TEXTURE_ENV, GL10.GL_TEXTURE_ENV_MODE, GL10.GL_REPLACE);
        if(!isPowerof2(mBitmap.getWidth())||!isPowerof2(mBitmap.getHeight()))
	...
	Bitmap PTImg(Bitmap bitmapOrg) {
		...
		int newWidth = closestPowerof2(width);
		int newHeight = closestPowerof2(height);
...
//		return x + 1;
//	}
//	boolean check2(int x)
//	{
//		int n=1;
//		for(int i=0;i<12&&n<x;i++){
//			n*=2;
//			if(n==x)
//				return true;
//		}
