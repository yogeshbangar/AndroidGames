...
public class Start extends BaseGameActivity
{
	...
	void DoNot()
	{
		new AlertDialog.Builder(this).setIcon(R.drawable.icon).setTitle("You do not have sufficient coins.")
				.setNeutralButton("Okay",new DialogInterface.OnClickListener() {public void onClick(DialogInterface dialog, int which) {
				}}).show();
	}
	void load(){
