...
public class M 
{
	...
	public static int achiment[] = {
		R.string.achievement_10_goals_in_one_sec,
		R.string.achievement_perfect_shooter,
		R.string.achievement_time_shooter,
		R.string.achievement_ultimate_shooter,
		R.string.achievement_super_star_shooter
	};
	public static int scoreID[] = {
		R.string.leaderboard_time,
		R.string.leaderboard_arcade,
		R.string.leaderboard_tournament,
		R.string.leaderboard_one_ball_shoot,
		R.string.leaderboard_target_shoot
	};
...
//	
	...
	public static final int GAMESPLSH	= 3;
	...
	public static final int GAMEJOIN= 8;
