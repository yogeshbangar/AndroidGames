...
public class Mesh 
{
	...
	public int Gift  = 0 ;
	public void drawRotet(GL10 gl,float rotateZ,float _x,float _y) 
	{
		gl.glPushMatrix();
...
//			gl.glColor4f(t,t,t,t);
	...
	public void drawScalRotet(GL10 gl,float Scalx,float Scaly,float rotetZ,float moveX, float moveY) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
	...
	public void drawTil(GL10 gl,float x, float y) 
	{
	 	gl.glPushMatrix();
		gl.glEnableClientState(GL10.GL_VERTEX_ARRAY);
		gl.glVertexPointer(3, GL10.GL_FLOAT, 0, mVerticesBuffer);
