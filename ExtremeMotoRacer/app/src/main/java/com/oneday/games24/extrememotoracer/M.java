...
public class M 
{
	...
	public static final String MY_AD_UNIT_ID = "ca-app-pub-3395412980708319/5575918188";//Banner
	public static final String MY_AD_UNIT_IDF ="ca-app-pub-3395412980708319/5575918188";//Full
	public static final String HOUSE_ADV_ID  = "ca-app-pub-3395412980708319/5575918188";	//House Adv
	public static final String INTERSTITIAL_ID = "ca-app-pub-3395412980708319/5589264587";//Banner
//public static final String MY_AD_UNIT_ID = "a14fbcddede2f1e";//NE Mobile android market
...
//	public static final String MY_AD_UNIT_ID = "a14ee1fc6d6d477";	//handango
	public static final String Package[] = {
		"com.hututu.game.archeryking",
		"com.hututu.games.fightersofocean",
		"com.hututu.game.galaxyhunt",
		"com.hututu.game.helicoptercontrol",
		"com.hututu.game.papershot",
		"com.hututu.game.poker",
		"com.hututu.game.reversegravity",
		"com.hututu.game.ScarecrowvsBirds",
		"com.hututu.game.scarygames",
		"com.hututu.game.shootthebottle",
		"com.hututu.game.speeddragracing",
		"com.hututu.game.stuntracingcar",
		"com.hututu.app.torchledlight"
	};
	...
	public static void loadSound(Context context)
	{
		try{
			if(mpSplash==null)
				mpSplash = MediaPlayer.create(context, R.raw.splash);
//			if(mpGameplay==null)
//				mpGameplay = MediaPlayer.create(context, R.raw.gameplay_bike);
//			
			if(mpEffect==null)
				mpEffect = MediaPlayer.create(context, R.raw.button);//
			
			if(mpEffect2==null)
				mpEffect2 = MediaPlayer.create(context, R.raw.crash);
			
//			if(mpEffect3==null)
//				mpEffect3 = MediaPlayer.create(context, R.raw.crash);//
	
			if(mpEffect4==null)
				mpEffect4 = MediaPlayer.create(context, R.raw.gameover);
			
			if(mpEffect5==null)
				mpEffect5 = MediaPlayer.create(context, R.raw.levelwin);
			
			if(mpEffect6==null)
				mpEffect6 = MediaPlayer.create(context, R.raw.coin);
			
			if(mpEffect7==null)
				mpEffect7 = MediaPlayer.create(context, R.raw.coin2);
			
			if(mpEffect8==null)
				mpEffect8 = MediaPlayer.create(context, R.raw.coin);
			
			if(mpEffect9==null)
				mpEffect9 = MediaPlayer.create(context, R.raw.bike);
			
//			if(mpEffect10==null)
//				mpEffect10 = MediaPlayer.create(context, R.raw.coin2);
//			if(mpEffect11==null)
//				mpEffect11 = MediaPlayer.create(context, R.raw.coin2);
//			if(mpEffect12==null)
//				mpEffect12 = MediaPlayer.create(context, R.raw.coin2);
//			if(mpEffect13==null)
//				mpEffect13 = MediaPlayer.create(context, R.raw.coin2);
//			
...
//			sound6(context,R.raw.power);
	...
	public static void CallBost(Context context ,int no)
	{
		switch (no) {
		case 0:
			sound10(context, R.raw.bike_boost);
			break;
		case 1:
			sound11(context, R.raw.car_boost);
			break;
		case 2:
			sound12(context, R.raw.car_boost);
			break;
		case 3:
		default:
			sound13(context, R.raw.car_boost);
			break;
		}
	}
