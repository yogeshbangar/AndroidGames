...
public class M 
{
	public static final int ACHIV[] = {
		  ...
		  R.string.achievement_king_racer
	};
...
//	
	public static final short SPD = 6;
	public static final short DIS = 7;
	public static final short ARR = 710;
