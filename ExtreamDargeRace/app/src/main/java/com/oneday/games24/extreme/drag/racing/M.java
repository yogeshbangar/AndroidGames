...
//					sound4(context,R.drawable.g4);
	...
	public static void startSound(int no)
	{
		...
		if(no<8){
			M.sound1(GameRenderer.mContext, R.raw.bike_start_01);
		}else if(no<15){
			M.sound2(GameRenderer.mContext, R.raw.bike_start_02);
		}else{
			M.sound3(GameRenderer.mContext, R.raw.bike_start_03);
		}
	}
	...
	public static void BikeSound(int no)
	{
		...
		case 0:
		case 1:
			M.sound4(GameRenderer.mContext, R.raw.bike_01);
			break;
		case 2:
		case 3:
			M.sound5(GameRenderer.mContext, R.raw.bike_02);
			break;
		case 4:
		case 5:
			M.sound6(GameRenderer.mContext, R.raw.bike_03);
			break;
		case 6:
		case 7:
			M.sound7(GameRenderer.mContext, R.raw.bike_04);
			break;
		case 8:
		case 9:
			M.sound8(GameRenderer.mContext, R.raw.bike_05);
			break;
		case 10:
		case 11:
			M.sound9(GameRenderer.mContext, R.raw.bike_06);
			break;
		case 12:
		case 13:
		case 14:	
			M.sound10(GameRenderer.mContext, R.raw.bike_07);
			break;
		
		case 15:
		case 16:
		case 17:
			M.sound11(GameRenderer.mContext, R.raw.bike_08);
			break;
		default:
			M.sound4(GameRenderer.mContext, R.raw.bike_01);
			break;
