...
public class GameRenderer implements Renderer  {
	...
	SimplePlane[] mTex_Driver,mTex_SBack,mTex_Arrow,mTex_City[],mTex_Engin, mTex_Exhaust,mTex_Smock,mTex_Nitro;
	...
	SimplePlane mTex_Kata,mTex_Star, mTex_Logo, mTex_CommandBG,mTex_GarageB,mTex_PowerBar,mTex_BykFG, mTex_Cont;
...
//			mStart.adHouse.setVisibility(msg.what);
	...
	void init() {
		try {
			...
			mTex_Exhaust = new SimplePlane[2];
			mTex_Exhaust[0] = add("Garage/exhaus_lockt.png");
			mTex_Exhaust[1] = add("Garage/exhaust_install.png");
			...
			mTex_CommandBG = add("ComanBG.png");
