...
public class MainActivity {
	...
	static final String SKU_10000 = "one";//Get 10000 Coin (one)
...
//		String base64EncodedPublicKey = "";
		String base64EncodedPublicKey = "";
...
//				complain("Error purchasing: " + result);
			...
			if (purchase.getSku().equals(SKU_10000)) {
				GameRenderer.mStart.mGR.mDoller += 20000;
				alert("Success");
			}
			if (purchase.getSku().equals(SKU_30000)) {
				GameRenderer.mStart.mGR.mDoller += 50000;
				alert("Success");
			}
			if (purchase.getSku().equals(SKU_50000)) {
				GameRenderer.mStart.mGR.mDoller += 80000;
				alert("Success");
			}
			if (purchase.getSku().equals(SKU_100000)) {
				GameRenderer.mStart.mGR.mDoller += 150000;
				alert("Success");
			}
