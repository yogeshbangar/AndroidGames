...
public class M 
{
	...
	public static final int[] ACHIV = { 
		R.string.achievement_one_bike_unlock,
		R.string.achievement_one_world_unlock,
		R.string.achievement_five_bike_unlock,
		R.string.achievement_10_bike_unlock,
		R.string.achievement_all_bike_unlock,
		R.string.achievement_all_world_unlock 
		};
...
//					sound4(context,R.drawable.g4);
	...
	public static void startSound(int no)
	{
		
		if(no<8){
			M.sound1(GameRenderer.mContext, R.drawable.bike_start_01);
		}else if(no<15){
			M.sound2(GameRenderer.mContext, R.drawable.bike_start_02);
		}else{
			M.sound3(GameRenderer.mContext, R.drawable.bike_start_03);
		}
	}
	...
	public static void BikeSound(int no)
	{
		
		switch (no) {
		case 0:
		case 1:
			M.sound4(GameRenderer.mContext, R.drawable.bike_01);
			break;
		case 2:
		case 3:
			M.sound5(GameRenderer.mContext, R.drawable.bike_02);
			break;
		case 4:
		case 5:
			M.sound6(GameRenderer.mContext, R.drawable.bike_03);
			break;
		case 6:
		case 7:
			M.sound7(GameRenderer.mContext, R.drawable.bike_04);
			break;
		case 8:
		case 9:
			M.sound8(GameRenderer.mContext, R.drawable.bike_05);
			break;
		case 10:
		case 11:
			M.sound9(GameRenderer.mContext, R.drawable.bike_06);
			break;
		case 12:
		case 13:
		case 14:	
			M.sound10(GameRenderer.mContext, R.drawable.bike_07);
			break;
		
		case 15:
		case 16:
		case 17:
			M.sound11(GameRenderer.mContext, R.drawable.bike_08);
			break;
		default:
			M.sound4(GameRenderer.mContext, R.drawable.bike_01);
			break;
	...
	public static void BikeSoundStop()
	{
		if (mpEffect4 != null)
		{
			mpEffect4.release();
