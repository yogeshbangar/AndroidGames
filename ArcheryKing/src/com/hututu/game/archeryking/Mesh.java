...
//	private final float[] mRGBA = new float[] { 1.0f, 1.0f, 1.0f, 1.0f };
	...
	public void drawColor(GL10 gl,float x, float y,float r,float g,float b) 
	{
		gl.glPushMatrix();
	...
	public void drawScal(GL10 gl,float x,float y,float sx, float sy,float r,float g,float b) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
	...
	public void drawRotet(GL10 gl,float rotateX,float rotateY,float rotateZ,float _x,float _y,float t) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
	...
	public void drawRotet1(GL10 gl,float rotateX,float rotateY,float rotateZ,float _x,float _y,float t) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
	...
	public void drawRotet2(GL10 gl,float rotateX,float rotateY,float rotateZ,float _x,float _y,float t,float tt) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
	...
	public void drawRotet3(GL10 gl,float rotateX,float rotateY,float rotateZ,float _x,float _y,float t) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
		...
		gl.glScalef(M.ScreenHieght/M.ScreenWidth,1,0);
		gl.glRotatef(rotateZ, 0, 0, 1);
		gl.glTranslatef(0,-Height()*.4f,0);
//		gl.glTranslatef(width()*1.5f,0,0);
