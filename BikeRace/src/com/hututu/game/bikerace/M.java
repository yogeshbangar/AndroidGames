...
public class M 
{
	public static final int BIKEPRICE[] = {0,10000,50000};
	...
	public static void play( int resource) 
	{
		try{
			...
			{
				if(mp==null)
					mp = MediaPlayer.create(CallActivity.mContext, resource);
	...
	public static void sound1( int resource) {
		...
		try{
			if(mpEffect==null)
			{
				mpEffect = MediaPlayer.create(CallActivity.mContext, resource);
			}
...
//				sound2(CallActivity.mContext,R.drawable.g2);
	...
	public static void sound2( int resource) {
		...
		try{
			if(mpEffect2==null)
			{
				mpEffect2 = MediaPlayer.create(CallActivity.mContext, resource);
			}
...
//				sound3Play(CallActivity.mContext,R.drawable.g3);
	...
	public static void sound3( int resource) {
		...
		try{
			...
			{
				if(mpEffect3==null)
					mpEffect3 = MediaPlayer.create(CallActivity.mContext, resource);
	...
	public static void sound4( int resource) {
		...
		try{
			if(mpEffect4==null)
			{
				mpEffect4 = MediaPlayer.create(CallActivity.mContext, resource);
			}
	...
	public static void sound5( int resource) {
		...
		try{
			if(mpEffect5==null)
		{
			mpEffect5 = MediaPlayer.create(CallActivity.mContext, resource);
		}
	...
	public static void sound6( int resource) {
		...
		try{
			if(mpEffect6==null)
		{
				mpEffect6 = MediaPlayer.create(CallActivity.mContext, resource);
		}
	...
	public static void sound7( int resource) {
		...
		try{
			if(mpEffect7==null)
		{
				mpEffect7 = MediaPlayer.create(CallActivity.mContext, resource);
		}
	...
	public static void sound8( int resource) {
		...
		try{
			if(mpEffect8==null)
		{
				mpEffect8 = MediaPlayer.create(CallActivity.mContext, resource);
		}
	...
	public static void sound9( int resource) {
		...
		try{
			if(mpEffect9==null)
		{
				mpEffect9 = MediaPlayer.create(CallActivity.mContext, resource);
		}
	...
	public static void sound10( int resource) {
		...
		try{
			if(mpEffect10==null)
		{
				mpEffect10 = MediaPlayer.create(CallActivity.mContext, resource);
		}
	...
	public static void sound11( int resource) {
		...
		try{
			if(mpEffect11==null)
		{
				mpEffect11 = MediaPlayer.create(CallActivity.mContext, resource);
		}
	...
	public static void sound12( int resource) {
		...
		try{
			if(mpEffect12==null)
		{
				mpEffect12 = MediaPlayer.create(CallActivity.mContext, resource);
		}
	...
	public static void sound13( int resource) {
		...
		try{
			if(mpEffect13==null)
		{
				mpEffect13 = MediaPlayer.create(CallActivity.mContext, resource);
		}
	...
	public static void sound14( int resource) {
		...
		try{
			if(mpEffect14==null)
		{
				mpEffect14 = MediaPlayer.create(CallActivity.mContext, resource);
		}
	...
	public static void sound15( int resource) {
		...
		try{
			if(mpEffect15==null)
		{
				mpEffect15 = MediaPlayer.create(CallActivity.mContext, resource);
		}
