...
//	
	...
	public static final int GAMELOGO = 0, GAMEADD  = 1, GAMEMENU  = 2, GAMELOAD  = 3, GAMEPLAY = 4;
	public static final int GAMEHELP = 5, GAMEOVER = 6, GAMEABOUT = 7, GAMELEVEL = 8, GAMEPUSE = 9;
	...
	public static final float SC = .25f;
