...
public class InApp {
	...
	static final String SKU_20000 = "two";//Get 30000 Coin (two)
	...
	public void onCreate() {
		String base64EncodedPublicKey = "";
...
//				complain("Error purchasing: " + result);
			...
			if (purchase.getSku().equals(SKU_10000)) {
				GameRenderer.mStart.mGR.mGold+=5000;
				alert("Success");
			}
			if (purchase.getSku().equals(SKU_20000)) {
				GameRenderer.mStart.mGR.mGold+=10000;
				alert("Success");
			}
			if (purchase.getSku().equals(SKU_30000)) {
				GameRenderer.mStart.mGR.mGold+=40000;
				alert("Success");
			}
			if (purchase.getSku().equals(SKU_40000)) {
				GameRenderer.mStart.mGR.mGold+=90000;
				alert("Success");
			}
