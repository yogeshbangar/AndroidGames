...
//				sound3Play(CallActivity.mContext,R.drawable.g3);
	...
	public static void Bikeplay(int bike, boolean isBoost) {
		if (isBoost) {
			...
			switch (bike) {
			case 0:
				M.sound2(R.raw.bike0_boost);
				break;
			case 1:
				M.sound2(R.raw.bike1_boost);
				break;
			case 2:
				M.sound2(R.raw.bike2_boost);
				break;
			}
		} else {
			if (mpEffect2 != null) {
			...
			switch (bike) {
			case 0:
				M.sound1(R.raw.bike0_normal);
				break;
			case 1:
				M.sound1(R.raw.bike1_normal);
				break;
			case 2:
				M.sound1(R.raw.bike2_normal);
				break;
			}
		}
	}
