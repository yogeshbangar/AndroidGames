...
//		DrawTransScal(gl, mGR.mTex_info	, 0.9f, .84f-(1*.26f),mGR.mSel==2?1.2f:1,mGR.mSel==2?.5f:1);
	...
	{
		mGR.mSel = 0;
		if(CircRectsOverlap(0.9f, .84f-(0*.26f), mGR.mTex_fb.width()*.4f, mGR.mTex_fb.Height()*.4f, screen2worldX(event.getX()), screen2worldY(event.getY()), .05f))
		{
			mGR.mSel = 1;//FaceBook
		}
		if(CircRectsOverlap(0.9f, .84f-(1*.26f), mGR.mTex_fb.width()*.4f, mGR.mTex_fb.Height()*.4f, screen2worldX(event.getX()), screen2worldY(event.getY()), .05f))
		{
//			mGR.mSel = 2;//About
		}
		if(CircRectsOverlap(0.9f, .84f-(2*.26f), mGR.mTex_fb.width()*.4f, mGR.mTex_fb.Height()*.4f, screen2worldX(event.getX()), screen2worldY(event.getY()), .05f))
		{
