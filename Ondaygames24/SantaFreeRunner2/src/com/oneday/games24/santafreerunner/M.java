...
public class M 
{
	...
	public static final String SHARELINK 	= "https://play.google.com/store/apps/details?id=com.oneday.games24.santafreerunner";
	...
	public static final int GAMELOGO = 0 ,GAMEADD = 1,GAMEMENU = 3,GAMEHIGH=4,GAMEPLAY = 5;
	public static final int GAMEHELP   = 7,GAMEOVER = 8,GAMEABOUT = 9,GAMELEVEL = 10,GAMEPAUSE = 11;
	public static final int GAMELOAD = 12,GAMEINFO = 13;
	public static final String HOUSE_ADV_ID  = "ca-app-pub-3395412980708319/8098844981";	//AdHouse
	...
	public static final String MY_AD_UNIT_ID = "ca-app-pub-3395412980708319/6622111784";	//AndroidMarket
	
	
	public static float Speed = -.03f;
...
//					sound4(context,R.drawable.g4);
	...
	public static void sound4(Context context, int resource) {
		...
		try{
			...
			if(!mpEffect4.isPlaying() && setValue)
				...
				sound5(context,R.drawable.jump0);
		}catch(Exception e){}
	}
	...
	public static void sound6(Context context, int resource) {
		...
		if(!mpEffect6.isPlaying() && setValue)
			...
			sound7(context,R.drawable.jump1);
		}catch(Exception e){}
	}
