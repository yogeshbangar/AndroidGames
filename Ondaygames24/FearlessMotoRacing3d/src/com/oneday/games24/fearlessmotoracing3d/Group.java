...
//		Handle(event);
	...
	void logo(){
		...
		/*mGR.m3d_MD1.setVisible(true);
		
		mGR.m3d_Egle.setVisible(true);
		mGR.m3d_Egle.setScale(.05f);
		mGR.m3d_Egle.setRotation(counter, counter, counter);
		
		mGR.m3d_B2.setVisible(true);
		mGR.m3d_B2.setScale(.0225);
		mGR.m3d_B2.setRotation(sx*100, sy*100, sz*100);*/
		
		if(counter> 100){
			M.GameScreen = M.GAMESPLASH;
			mGR.setVisible(false);
			HTTRenderer.mStart.load();
...
//		mGR.oSencer[1].setScale(sel == 3 ? 1.05f :.95f);
		...
		mGR.oAchiv.setScale(sel == 8 ?1.1:1);
...
//				mGR.gameReset();
	...
	void Draw_GamePlay(){
		...
		if(mGR.chalage){
			...
			mGR.oChallange.setVisible(true);
			mGR.oChallange.setPosition(0, 0, 1.50);
			mGR.oChallange.setScale(1);
			mGR.oChallange.setRotation(180, 0, 180);
...
//				Player.mTotalCoin +=Track.Challenges[mGR.Challenge%Track.Challenges.length][4];
		...
		if(mGR.ChallengeCom > 0 && mGR.ChallengeCom < 200) {
			...
			mGR.ChallangeUpdate();
			mGR.oChallange.setVisible(true);
			mGR.oChallange.setPosition(.235, -1.823, 1.50);
			mGR.oChallange.setScale(1);
			mGR.oChallange.setRotation(124, 0, 180);
		}
