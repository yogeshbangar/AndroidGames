...
public class M 
{
	...
	public static final String SHARELINK 	= "https://play.google.com/store/apps/details?id=com.oneday.games24.gravityracerboy";
//	
	...
	public static final int GAMESET	= 7;
	public static final int GAMELVL	= 8;
...
//					sound4(GameRenderer.mContext,R.drawable.g4);
	...
	static public void Jump(){
		...
		case 0:
			sound3(R.drawable.jump1);
			break;
		case 2:
			sound4(R.drawable.jump2);
			break;
		case 3:
			sound5(R.drawable.jump3);
			break;
		default:
			sound6(R.drawable.jump4);
			break;
		}
	}
