...
//			mStart.load();
	...
	public void onDrawFrame(GL10 gl) 
	{
		...
		{
			resumeCounter++;
			if((M.GameScreen !=  M.GameChallenge&& M.GameScreen != M.GamePause && M.GameScreen != M.GameOver &&  M.GameScreen != M.GameADD))
			{
		...
		{
			if((M.GameScreen == M.GamePause || (M.GameScreen == M.GameOver && mGR.ads %3 != 0)||M.GameScreen ==  M.GameChallenge))
			{
