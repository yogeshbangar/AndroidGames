...
public class M 
{
	public static final String DIR = "/face_changer";
	...
	public static final String SHARELINK 	= "https://play.google.com/store/apps/details?id=com.oneday.games24.funnyfacechanger";
////	
	public static Random mRand = new Random();
	public static final String score = "score";
	public static int AppScreen;
	public static final int APPHTT 	= 0;
	public static final int APPMENU 	= 1;
	public static final int APPEDIT 	= 2;
	public static final int APPMAIN	= 4;
	public static final int APPSUB	= 5;
	public static final int APPCLIPS	= 6;
	public static final int APPABOUT	= 7;
	public static final int APPOPTION= 8;
