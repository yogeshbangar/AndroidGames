			 ...
			 if(mStart.adBanner!=null)
	 		 {
				...
				if(!mStart.addFree &&(M.GameScreen == M.GAMEABTUS   ||  M.GameScreen == M.GAMEPAUSE || M.GameScreen == M.GAMEOVER || M.GameScreen == M.GAMESETTING
									  || M.GameScreen == M.GAMEHELP ||  M.GameScreen == M.GAMEWORLD || M.GameScreen == M.GAMEMODE || M.GameScreen == M.GAMEADFREE))
				{
