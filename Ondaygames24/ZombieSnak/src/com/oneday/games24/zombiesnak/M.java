...
public class M 
{
	public static final int ACHIV[] = {
		  R.string.achievement_classic_zombile,
		  R.string.achievement_sharp_zombie,
		  R.string.achievement_man_zombie,
		  R.string.achievement_bird_zombie,
		  R.string.achievement_snake_zombie
	};
	public static final float SPD = -.025f;
