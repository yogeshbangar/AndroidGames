...
//	private final float[] mRGBA = new float[] { 1.0f, 1.0f, 1.0f, 1.0f };
	...
	public void drawRS(GL10 gl,float _x,float _y,float scal,float rotate) 
	{
		gl.glPushMatrix();
		...
		gl.glTranslatef(0,-Height()*scal*.5f, 0);
	...
	public void drawRS2(GL10 gl,float _x,float _y,float scal,float rotate) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
