...
public class M 
{
	static float speed 		= 1.101f;
	static float oPPSpeed 	= -.05f;
	...
	public static final int GAMELOGO = 0 ,GAMEADD = 1,GAMESPLASH = 2,GAMEMENU = 3,GAMEPAUSE=4,GAMEPLAY = 5;
	public static final int GAMEHELP   = 7,GAMEOVER = 8,GAMEABOUT = 9,GAMETIMEUP = 10,GAMEHS = 11;
	...
	public static final String MY_AD_UNIT_ID = "ca-app-pub-3395412980708319/1773109781";	//AndroidMarket
	public static final String HOUSE_ADV_ID  = "ca-app-pub-3395412980708319/3249842985";	//
	public static void loadSound(Context context)
	{
		try{
			...
			if(mpEffect==null)
				mpEffect = MediaPlayer.create(context, R.drawable.collision);//
