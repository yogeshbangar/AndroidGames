...
//	private final float[] mRGBA = new float[] { 1.0f, 1.0f, 1.0f, 1.0f };
	...
	public void drawRotet(GL10 gl,float _x,float _y,float rotate,float scal,float t) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
		...
		gl.glScalef((M.ScreenHieght/M.ScreenWidth)*scal,scal,0);
	...
	public void drawCar(GL10 gl,float _x,float _y,float rotate,float dir) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
		...
		gl.glRotatef(rotate, 0, 0, 1);
		gl.glTranslatef(0,dir*Height(),0);
	...
	public void drawSS(GL10 gl,float x,float y,float sx, float sy,float r) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
	...
	public void drawRed(GL10 gl,float x, float y, float z)
    {
        gl.glPushMatrix();
        gl.glEnableClientState(GL10.GL_VERTEX_ARRAY);
        gl.glVertexPointer(3, GL10.GL_FLOAT, 0, mVerticesBuffer);
	...
	public void drawSedo(GL10 gl,float x, float y,float tran)
    {
        gl.glPushMatrix();
        gl.glEnableClientState(GL10.GL_VERTEX_ARRAY);
        gl.glVertexPointer(3, GL10.GL_FLOAT, 0, mVerticesBuffer);
