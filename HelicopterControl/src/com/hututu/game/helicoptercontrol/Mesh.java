...
public class Mesh 
{
	...
	public void drawRotScal(GL10 gl,float x,float y,float scalx, float scaly,float ang) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
		...
		gl.glTranslatef(x, y, 0);
		gl.glScalef((M.ScreenHieght/M.ScreenWidth)*scalx,scaly, 0);
	...
	public void drawRotet(GL10 gl,float rotate,float _x,float _y) 
	 {
		 gl.glPushMatrix();
		 gl.glFrontFace(GL10.GL_CCW);
		 gl.glEnable(GL10.GL_CULL_FACE);
	...
	/*public void drawRotet(GL10 gl,float rotateX,float rotateY,float rotateZ,float _x,float _y) 
	{
		...
		gl.glVertexPointer(3, GL10.GL_FLOAT, 0, mVerticesBuffer);
		 ...
		 gl.glTranslatef(_x,_y,0);
		 gl.glScalef(M.ScreenWidth/M.ScreenHieght,M.ScreenWidth/M.ScreenHieght,0);
	...
	public void drawScalFad(GL10 gl,float x,float y,float Scal,float Fadv) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
		...
		if (mTextureId != -1 && mTextureBuffer != null) {
			...
			gl.glEnable(GL10.GL_BLEND);
			gl.glColor4f(Fadv,Fadv,Fadv,Fadv);
			gl.glBlendFunc(GL10.GL_TRUE, GL10.GL_ONE_MINUS_SRC_ALPHA);
//			gl.glBlendFunc(GL10.GL_ONE,GL10.GL_ONE_MINUS_SRC_ALPHA);
...
//		    gl.glClearColor(0F, 0F, 0F, 0);
	...
	public void drawFilp(GL10 gl,float x, float y,float scalx,float scaly)
    {
        gl.glPushMatrix();
        gl.glEnableClientState(GL10.GL_VERTEX_ARRAY);
        gl.glVertexPointer(3, GL10.GL_FLOAT, 0, mVerticesBuffer);
