...
public class Start extends Activity {
    ...
    void pause() {
        ...
        editor.putInt("mPlayerangleno", mGR.mPlayer.angle);
        editor.putInt("mPlayerspeedno", mGR.mPlayer.speed);
        editor.putInt("mPlayermThukai", mGR.mPlayer.accident);
    ...
    void resume() {
        ...
        mGR.mPlayer.angle = prefs.getInt("mPlayerangleno", mGR.mPlayer.angle);
        mGR.mPlayer.speed = prefs.getInt("mPlayerspeedno", mGR.mPlayer.speed);
        mGR.mPlayer.accident = prefs.getInt("mPlayermThukai", mGR.mPlayer.accident);
