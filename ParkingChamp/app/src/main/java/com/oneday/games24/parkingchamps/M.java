...
public class M {
    ...
    public static final String SHARELINK = "https://play.google.com/store/apps/details?id=com.oneday.games24.parkingchamps";
    public static Random mRand = new Random();
    public static final String score = "score";
    public static int GameScreen;
    public static final int GAMELOGO = 0, GAMEADD = 1, GAMEMENU = 3, GAMESETT = 4, GAMEPLAY = 5;
    public static final int GAMEHELP = 7, GAMEOVER = 8, GAMEA = 9, GAMELEVEL = 10, GAMEWIN = 11;
    public static final int GAMECONG = 12, GAMEINFO = 13, GAMEPAUSE = 14, GAMELOADING = 15;
    ...
    public static boolean setVibrator = true;
    ...
    public static final String MY_AD_UNIT_ID = "ca-app-pub-3395412980708319/2471113789";    //AndroidMarket
    public static final String HOUSE_ADV_ID = "ca-app-pub-3395412980708319/3947846986";    //AdHouse
    ...
    public static void loadSound(Context context) {
        try {
            ...
            if (mpEffect2 == null)
                mpEffect2 = MediaPlayer.create(context, R.raw.carblast);

            if (mpEffect3 == null)
                mpEffect3 = MediaPlayer.create(context, R.raw.gameover);//

            if (mpEffect4 == null)
                mpEffect4 = MediaPlayer.create(context, R.raw.lavelcomp);//
