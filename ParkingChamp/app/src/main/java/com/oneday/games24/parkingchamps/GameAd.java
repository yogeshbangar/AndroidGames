...
//                    if(!GameRenderer.mStart.mGR.isReword) {
//                        int coin = GameRenderer.mStart.mGR.mTotalCoin + 500;
//                        editor.putInt("mTotalCoin", coin);
//                    }else{
//                        int mNoKey = GameRenderer.mStart.mGR.mNoKey + 5;
//                        editor.putInt("mNoKey", mNoKey);
//                    }
                    editor.commit();
