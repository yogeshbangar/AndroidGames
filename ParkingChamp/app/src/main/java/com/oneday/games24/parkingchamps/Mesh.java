...
public class Mesh {
    ...
    public void drawRotate(GL10 gl, float _x, float _y, float rotate, float t) {
        gl.glPushMatrix();
    ...
    public void drawRotateC(GL10 gl, float _x, float _y, float rotate, float t) {
        gl.glPushMatrix();
        gl.glFrontFace(GL10.GL_CCW);
        gl.glEnable(GL10.GL_CULL_FACE);
        gl.glCullFace(GL10.GL_BACK);
    ...
    public void drawRGBS(GL10 gl, float _x, float _y, float r, float g, float b, float a) {
        gl.glPushMatrix();
        gl.glFrontFace(GL10.GL_CCW);
        gl.glEnable(GL10.GL_CULL_FACE);
        gl.glCullFace(GL10.GL_BACK);
    ...
    public void drawTSR(GL10 gl, float x, float y, float z, float t, float r) {
        gl.glPushMatrix();
        gl.glEnableClientState(GL10.GL_VERTEX_ARRAY);
        gl.glVertexPointer(3, GL10.GL_FLOAT, 0, mVerticesBuffer);
        if (mShouldLoadTexture) {
