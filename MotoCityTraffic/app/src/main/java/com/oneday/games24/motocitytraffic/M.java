...
//	public static final String MY_BANNER_ID        = "ca-app-pub-3395412980708319/9684400183";	//AndroidMarket
	...
	{
		try{
			mpBG        =  MediaPlayer.create(context, R.raw.bg);
			mpEffect    =  MediaPlayer.create(context, R.raw.coin);
			mpEffect2   =  MediaPlayer.create(context, R.raw.carcrash0);
			mpEffect3   =  MediaPlayer.create(context, R.raw.carcrash1);
			mpEffect4   =  MediaPlayer.create(context, R.raw.car_pass0);
			mpEffect41  =  MediaPlayer.create(context, R.raw.car_pass0);
			mpEffect42  =  MediaPlayer.create(context, R.raw.car_pass0);
			mpEffect5   =  MediaPlayer.create(context, R.raw.car_pass1);
			mpEffect51  =  MediaPlayer.create(context, R.raw.car_pass1);
			mpEffect52  =  MediaPlayer.create(context, R.raw.car_pass1);
			mpEffect6   =  MediaPlayer.create(context, R.raw.police_car);
			mpEffect7   =  MediaPlayer.create(context, R.raw.click);
			mpBG1	    =  MediaPlayer.create(context, R.raw.splash_theme);
			mpEffect8   =  MediaPlayer.create(context, R.raw.freecoin);
