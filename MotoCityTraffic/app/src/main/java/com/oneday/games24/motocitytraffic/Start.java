    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            switch (M.GameScreen) {
                ...
                case M.GAMEUSEPOWER:
                    if (M.SetBG)
                        M.BGPlay(GameRenderer.mStart, R.raw.bg);
...
//			return false;
    ...
    void resetvalue() {
        ...
        for (i = 0; i < mGR.isChallenge.length; i++) {
    ...
    void pause() {
        ...
        editor.putFloat("mScal", mGR.root.mScale);
...
//	    editor.putFloat("mPopVX",mGR.mPopVX);
        ...
        for (i = 0; i < mGR.mCar.length; i++) {
            ...
            editor.putBoolean("isTuunel" + i, mGR.mCar[i].isTunnel);
        ...
        editor.putInt("mChallangetime", mGR.mChallengeSec);

        for (i = 0; i < mGR.isChallenge.length; i++) {
            editor.putBoolean("isChallange" + i, mGR.isChallenge[i]);
        }
        for (i = 0; i < mGR.isAchieve.length; i++) {
    ...
    void resume() {
        ...
        mGR.root.mScale = prefs.getFloat("mScal", mGR.root.mScale);
...
//		mGR.mPopVX = prefs.getFloat("mPopVX",mGR.mPopVX);
        ...
        for (i = 0; i < mGR.mCar.length; i++) {
            ...
            mGR.mCar[i].isTunnel = prefs.getBoolean("isTuunel" + i, mGR.mCar[i].isTunnel);
        ...
        mGR.mChallengeSec = prefs.getInt("mChallangetime", mGR.mChallengeSec);
        for (i = 0; i < mGR.isChallenge.length; i++) {
            mGR.isChallenge[i] = prefs.getBoolean("isChallange" + i, mGR.isChallenge[i]);
        }
        for (i = 0; i < mGR.isAchieve.length; i++) {
