...
//	private final float[] mRGBA = new float[] { 1.0f, 1.0f, 1.0f, 1.0f };
	...
	public void drawRotet(GL10 gl,float _x,float _y,float ang) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
	...
	public void drawRotet2(GL10 gl, float _x, float _y, float r,float pos) {
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
		gl.glCullFace(GL10.GL_BACK);
		...
		gl.glTranslatef(_x, _y, 0);
		gl.glScalef(1, M.ScreenWidth / M.ScreenHieght, 0);
