...
public class InApp {
	...
	static final String SKU_10000 = "one";//Get 100000 Coin (onr)
	static final String SKU_20000 = "two";//Get 300000 Coin (two)
	static final String SKU_30000 = "three";//Get 700000 Coin (three)
	static final String SKU_40000 ="four";//Get 1500000 Coin (four)
...
//		String base64EncodedPublicKey = "";
		String base64EncodedPublicKey = "";
...
//			}
	...
	public void onBuyGold20000(View arg0) {
		setWaitScreen(true);
		String payload = "";
		mHelper.launchPurchaseFlow(GameRenderer.mStart, SKU_20000, RC_REQUEST,mPurchaseFinishedListener, payload);
	}
	...
	public void onBuyGold40000(View arg0) {
		setWaitScreen(true);
		String payload = "";
		mHelper.launchPurchaseFlow(GameRenderer.mStart, SKU_40000, RC_REQUEST,mPurchaseFinishedListener, payload);
	}
...
//				complain("Error purchasing: " + result);
			...
			if (purchase.getSku().equals(SKU_10000)) {
				GameRenderer.mStart.mGR.mCoin+=100000;
				alert("Success");
			}
			if (purchase.getSku().equals(SKU_20000)) {
				GameRenderer.mStart.mGR.mCoin+=300000;
				alert("Success");
			}
			if (purchase.getSku().equals(SKU_30000)) {
				GameRenderer.mStart.mGR.mCoin+=700000;
				alert("Success");
			}
			if (purchase.getSku().equals(SKU_40000)) {
				GameRenderer.mStart.mGR.mCoin+=150000;
				alert("Success");
			}
