...
//	static final String SKU_10000 = "coins1000";// "premium";10000
	static final String SKU_50000 = "adsfree";// 25 balls per levels (adsfree)
...
//		String base64EncodedPublicKey = "";
		String base64EncodedPublicKey = "";
...
//				mPurchaseFinishedListener, payload);
	...
	IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener = new IabHelper.OnIabPurchaseFinishedListener() {
		public void onIabPurchaseFinished(IabResult result, Purchase purchase) {
			...
			System.out.println(GameRenderer.mStart.mGR.mTotalBall + " Purchase successful " + purchase.getSku());

			if (purchase.getSku().equals(SKU_50000)) {
				GameRenderer.mStart.mGR.mTotalBall = 25;
				GameRenderer.mStart.mGR.mULevel = 60;
				alert("Success");
			}
			GameRenderer.mStart.mGR.addFree = true;
			GameRenderer.mStart.pause();
			System.out.println(GameRenderer.mStart.mGR.mTotalBall + " Purchase 2 successful " + purchase.getSku());
		}
	};
