...
//	private final float[] mRGBA = new float[] { 1.0f, 1.0f, 1.0f, 1.0f };
	...
	public void drawSRGB(GL10 gl,float x, float y,float s, float r,float g, float b,float t)
    {
        gl.glPushMatrix();
	...
	public void drawRotet2(GL10 gl,float rotate,float _x,float _y,float s,float tt,float t) 
	{
		gl.glPushMatrix();
		gl.glFrontFace(GL10.GL_CCW);
		gl.glEnable(GL10.GL_CULL_FACE);
		...
		gl.glScalef((M.ScreenHieght/M.ScreenWidth)*s,s,0);
