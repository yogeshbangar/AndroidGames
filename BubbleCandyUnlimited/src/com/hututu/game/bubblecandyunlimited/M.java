...
public class M 
{
	public static final int ACHIV[]={
		  R.string.achievement_shooter,
		  R.string.achievement_super_shooter,
		  R.string.achievement_master_shooter,
		  R.string.achievement_royal_shooter,
		  R.string.achievement_king_shooter
	};
	...
	public static final String SHARELINK 	= "https://play.google.com/store/apps/details?id=com.hututu.game.bubblecandyunlimited";
	
	public static final float BY = .8f;
	public static final int Row=13, C=9;
	public static final byte NOBAL=8;
	...
	public static final int GAMEABOUT = 5;
	public static final int GAMECONG = 6;
	public static final int GAMEOPTION = 7;
	...
	public static void sound1( int resource) {
		...
		try{
			...
			if(!mpEffect.isPlaying())
				...
				sound2(R.drawable.bubbleblast2);
		}catch(Exception e){}	
	}
	public static void sound2( int resource) {
		...
		try{
			...
			if(!mpEffect2.isPlaying() && setValue)
				...
				sound3(R.drawable.bubbleblast3);
		}catch(Exception e){}
	}
		...
		try{
			if (setValue) 
			{
				...
				if(!mpEffect3.isPlaying())
				{
					...
					sound4(R.drawable.bubbleblast4);
			}
		}catch(Exception e){}
	}
	...
	public static void Blast(){
		...
		case 1:
			sound1(R.drawable.bubbleblast1);
			break;
		case 2:
			sound2(R.drawable.bubbleblast2);
			break;
	...
	public static void HIT(){
		switch (mRand.nextInt(4)) {
		case 1:
			sound6(R.drawable.bubble_hit1);
			break;
		case 2:
			sound7(R.drawable.bubble_hit2);
			break;
		case 3:
			sound8(R.drawable.bubble_hit3);
			break;
		default:
			sound9(R.drawable.bubble_hit0);
			break;
		}
	}
