...
public class MainActivity {
	...
	static final String KEYS10	  		= "10key";
	static final String KEYS25	  		= "25key";
	static final String KEYS60	  		= "60key";
	static final String KEYS100	  		= "100key";
	static final String COIN5000 		= "5000coin"; 
	static final String COIN20000 		= "20000coin";
	static final String COIN50000 		= "50000coin";
	static final String COIN100000 		= "100000coin";
	static final String WORLD5000 		= "5000world";
	static final String WORLD7500 		= "7500world";
	static final String WORLD10000 		= "10000world";
...
//			R.drawable.gas2, R.drawable.gas3, R.drawable.gas4 };
	...
	public void onCreate() {
		 ...
		 */
		String base64EncodedPublicKey = "";
...
//			
	...
	/*************************************************************/
	public void onBuyAdfree(View arg0) {
		System.out.println(TAG+ "Buy gas button clicked.");
		setWaitScreen(true);
		System.out.println(TAG+ "Launching purchase flow for gas.");
		String payload = "";
		mHelper.launchPurchaseFlow(GameRenderer.mStart,ADFREE,RC_REQUEST,mPurchaseFinishedListener, payload);
	}
	public void onBuy10Key(View arg0) {
		System.out.println(TAG+ "Buy gas button clicked.");
		setWaitScreen(true);
		System.out.println(TAG+ "Launching purchase flow for gas.");
		String payload = "";
		mHelper.launchPurchaseFlow(GameRenderer.mStart,KEYS10,RC_REQUEST,mPurchaseFinishedListener, payload);
	}
	public void onBuy25Key(View arg0) {
		System.out.println(TAG+ "Buy gas button clicked.");
		setWaitScreen(true);
		System.out.println(TAG+ "Launching purchase flow for gas.");
		String payload = "";
		mHelper.launchPurchaseFlow(GameRenderer.mStart,KEYS25,RC_REQUEST,mPurchaseFinishedListener, payload);
	}
	public void onBuy60Key(View arg0) {
		System.out.println(TAG+ "Buy gas button clicked.");
		setWaitScreen(true);
		System.out.println(TAG+ "Launching purchase flow for gas.");
		String payload = "";
		mHelper.launchPurchaseFlow(GameRenderer.mStart,KEYS60,RC_REQUEST,mPurchaseFinishedListener, payload);
	}
	public void onBuy100Key(View arg0) {
		System.out.println(TAG+ "Buy gas button clicked.");
		setWaitScreen(true);
		System.out.println(TAG+ "Launching purchase flow for gas.");
		String payload = "";
		mHelper.launchPurchaseFlow(GameRenderer.mStart,KEYS100,RC_REQUEST,mPurchaseFinishedListener, payload);
	}
	
	public void onBuyCoin5000(View arg0) {
		System.out.println(TAG+ "Buy gas button clicked.");
		setWaitScreen(true);
		System.out.println(TAG+ "Launching purchase flow for gas.");
		String payload = "";
		mHelper.launchPurchaseFlow(GameRenderer.mStart,COIN5000,RC_REQUEST,mPurchaseFinishedListener, payload);
	}
	public void onBuyCoin20000(View arg0) {
		System.out.println(TAG+ "Buy gas button clicked.");
		setWaitScreen(true);
		System.out.println(TAG+ "Launching purchase flow for gas.");
		String payload = "";
		mHelper.launchPurchaseFlow(GameRenderer.mStart,COIN20000,RC_REQUEST,mPurchaseFinishedListener, payload);
	}
	public void onBuyCoin50000(View arg0) {
		System.out.println(TAG+ "Buy gas button clicked.");
		setWaitScreen(true);
		System.out.println(TAG+ "Launching purchase flow for gas.");
		String payload = "";
		mHelper.launchPurchaseFlow(GameRenderer.mStart,COIN50000,RC_REQUEST,mPurchaseFinishedListener, payload);
	}
	public void onBuyCoin100000(View arg0) {
		System.out.println(TAG+ "Buy gas button clicked.");
		setWaitScreen(true);
		System.out.println(TAG+ "Launching purchase flow for gas.");
		String payload = "";
		mHelper.launchPurchaseFlow(GameRenderer.mStart,COIN100000,RC_REQUEST,mPurchaseFinishedListener, payload);
	}
	public void onBuyWorld5000(View arg0) {
		System.out.println(TAG+ "Buy gas button clicked.");
		setWaitScreen(true);
		System.out.println(TAG+ "Launching purchase flow for gas.");
		String payload = "";
		mHelper.launchPurchaseFlow(GameRenderer.mStart,WORLD5000,RC_REQUEST,mPurchaseFinishedListener, payload);
	}
	public void onBuyWorld7500(View arg0) {
		System.out.println(TAG+ "Buy gas button clicked.");
		setWaitScreen(true);
		System.out.println(TAG+ "Launching purchase flow for gas.");
		String payload = "";
		mHelper.launchPurchaseFlow(GameRenderer.mStart,WORLD7500,RC_REQUEST,mPurchaseFinishedListener, payload);
	}
	public void onBuyWorld10000(View arg0) {
		System.out.println(TAG+ "Buy gas button clicked.");
		setWaitScreen(true);
		System.out.println(TAG+ "Launching purchase flow for gas.");
		String payload = "";
		mHelper.launchPurchaseFlow(GameRenderer.mStart,WORLD10000,RC_REQUEST,mPurchaseFinishedListener, payload);
	}
...
//			System.out.println(TAG+" ~Successful~ "+ GameRenderer.mStart.mGR.Clock+GameRenderer.mStart.mGR.BuyStar + GameRenderer.mStart.addFree +purchase.getSku());
			...
			else if(purchase.getSku().equals(KEYS10)){
				GameRenderer.mStart.mGR.mNoKey+=10;
				alert("Success");
				mHelper.consumeAsync(purchase, mConsumeFinishedListener);
			}
			else if(purchase.getSku().equals(KEYS25)){
				GameRenderer.mStart.mGR.mNoKey+=25;
				alert("Success");
				mHelper.consumeAsync(purchase, mConsumeFinishedListener);
			}
			else if(purchase.getSku().equals(KEYS60)){
				GameRenderer.mStart.mGR.mNoKey+=60;
				alert("Success");
				mHelper.consumeAsync(purchase, mConsumeFinishedListener);
			}
			else if(purchase.getSku().equals(KEYS100)){
				GameRenderer.mStart.mGR.mNoKey+=100;
				alert("Success");
				mHelper.consumeAsync(purchase, mConsumeFinishedListener);
			}
			else if(purchase.getSku().equals(COIN5000)){
				GameRenderer.mStart.mGR.mTotalCoin+=5000;
				alert("Success");
				mHelper.consumeAsync(purchase, mConsumeFinishedListener);
			}
			else if(purchase.getSku().equals(COIN20000)){
				GameRenderer.mStart.mGR.mTotalCoin+=20000;
				alert("Success");
				mHelper.consumeAsync(purchase, mConsumeFinishedListener);
			}
			else if(purchase.getSku().equals(COIN50000)){
				GameRenderer.mStart.mGR.mTotalCoin+=50000;
				alert("Success");
				mHelper.consumeAsync(purchase, mConsumeFinishedListener);
			}
			else if(purchase.getSku().equals(COIN100000)){
				GameRenderer.mStart.mGR.mTotalCoin+=100000;
				alert("Success");
				mHelper.consumeAsync(purchase, mConsumeFinishedListener);
			}
			else if(purchase.getSku().equals(WORLD5000)){
				int id = GameRenderer.mStart.mGR.mWorldSel;
				GameRenderer.mStart.mGR.mWorld[id].isUnLock=true;
				alert("Success");
				mHelper.consumeAsync(purchase, mConsumeFinishedListener);
			}
			else if(purchase.getSku().equals(WORLD7500)){
				int id = GameRenderer.mStart.mGR.mWorldSel;
				GameRenderer.mStart.mGR.mWorld[id].isUnLock=true;
				GameRenderer.mStart.mGR.mTotalCoin+=2500;
				alert("Success");
				mHelper.consumeAsync(purchase, mConsumeFinishedListener);
			}
			else if(purchase.getSku().equals(WORLD10000)){
				int id = GameRenderer.mStart.mGR.mWorldSel;
				GameRenderer.mStart.mGR.mWorld[id].isUnLock=true;
				alert("Success");
				mHelper.consumeAsync(purchase, mConsumeFinishedListener);
