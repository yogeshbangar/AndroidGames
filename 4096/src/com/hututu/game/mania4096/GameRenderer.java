...
public class GameRenderer implements Renderer 
{
	...
	SimplePlane mTex_Fill,mTex_GameBoard,/*mTex_GameEnd,*/mTex_Star0,mTex_SwiptoMove,mTex_Gameover;
	...
	SimplePlane mTex_Later,mTex_Hand,mTex_Arrow,mTex_Arrow1;
...
//			mTex_Icn[0] = add("about_icon.png");
			mTex_Icn[0] = add("help_icon.png");
			mTex_Icn[1] = add("hututu_icon.png");
			mTex_Icn[2] = add("facebook_icon.png");
			mTex_Icn[3] = add("google_icon.png");
...
//			mTex_Yes = add("yes_button.png");
	...
	private Handler handler = new Handler() {public void handleMessage(Message msg) {mStart.load();}};
