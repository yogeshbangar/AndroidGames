...
public class M 
{
	...
	public static final String SHARELINK 	= "https://play.google.com/store/apps/details?id=com.hututu.game.reversegravity";
	
//	public static final String MARKET 		= "samsungapps://ProductDetail/com.hututu.game.reversegravity";
//	public static final String LINK 		= "samsungapps://ProductDetail/";
//	public static final String SHARELINK 	= "samsungapps://ProductDetail/com.hututu.game.reversegravity";
//	
...
//	public static final String SHARELINK 	= "http://www.amazon.com/gp/mas/dl/android?p=com.hututu.game.shootthebottle&showAll=1";
	...
	public static final float 	BGSPEED = -.001f;
	public static  		float 	SPEED  	= -.010f;
	public static final float 	SSPEED 	= -.010f;
	public static final float 	NSPEED 	= -.020f;
	public static final float 	FSPEED 	= -.030f;
	public static final float 	DIFF  	= 0.600f;
	
	public static int 			GameScreen;
	public static final int GAMELOGO = 0 ,GAMEMENU = 1,GAMEHIGH	 =  2,GAMEPLAY =  3,GAMEADD=50;
	public static final int GAMEHELP = 7 ,GAMEOVER = 8,GAMEPAUSE =  9,GAMEINFO = 10;
	...
	public static final String MY_AD_UNIT_ID = "ca-app-pub-3395412980708319/2191912180";	//AndroidMarket
	public static final String HOUSE_ADV_ID  = "ca-app-pub-3395412980708319/3668645386";	//AdHouse
