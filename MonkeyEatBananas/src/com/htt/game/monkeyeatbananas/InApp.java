...
public class InApp {
	...
	static final String SKU_20000 = "one";//Get 30000 Coin (two)
	static final String SKU_30000 = "one";//Get 50000 Coin (three)
	static final String SKU_40000 ="one";//Get 100000 Coin (four)
...
//		String base64EncodedPublicKey = "";
		String base64EncodedPublicKey = "";
...
//				GameRenderer.mStart.mGR.NoPower+=10;
//				alert("Success");
//			}
//			if (purchase.getSku().equals(SKU_20000)) {
//				GameRenderer.mStart.mGR.NoPower+=25;
//				alert("Success");
//			}
//			if (purchase.getSku().equals(SKU_30000)) {
//				GameRenderer.mStart.mGR.NoPower+=50;
//				alert("Success");
//			}
//			if (purchase.getSku().equals(SKU_40000)) {
//				GameRenderer.mStart.mGR.NoPower+=100;
//				alert("Success");
//			}
