...
public class M 
{
	public static final int ACHIV[] = {
		  R.string.achievement_divine,
		  R.string.achievement_pointed,
		  R.string.achievement_rapturous,
		  R.string.achievement_master,
		  R.string.achievement_godfather
	};
...
//	
	...
	public static final int GAMESARNDI = 3;
	public static final int GAMEPLAY = 5;
	public static final int GAMEOVER = 8;
	public static final int GAMEROKO = 11;
