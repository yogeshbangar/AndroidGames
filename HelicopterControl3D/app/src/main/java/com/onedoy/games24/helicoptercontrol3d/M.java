...
public class M 
{
	...
	static final String SGAME = "http://www.hututugames.com/resources/game.jpg";

	public static final int POINT[] = { 0,10,30,100};
	
	public static final int ROAD = 3;
	public static  float A = 300;
	public static  float B = .12f;
	public static final float SPD = -.3f;
	...
	public static final String BANNER 		= "market://details?id=com.game.onedaygames24.twowayracing3d";
	...
	public static final int GAMEPUASE	 = 6;
