...
public class M 
{
	...
	public static final int ACHIV[] = {
		  R.string.achievement_classic_timmber_boy,
		  R.string.achievement_sharp_boy,
		  R.string.achievement_exalted_boy,
		  R.string.achievement_master_boy,
		  R.string.achievement_king
	};
