...
public class DHelper implements GoogleApiClient.ConnectionCallbacks,
     ...
     */
    public DHelper(Activity activity, int clientsToUse) {
        mActivity = activity;
...
//        mConnectOnStart = false;
    ...
    public void onActivityResult(int requestCode, int responseCode,
        ...
        debugLog("onActivityResult: req="
                ...
                + EHelperUtils.activityResponseCodeToString(responseCode));
    ...
    public void onConnectionFailed(ConnectionResult result) {
        ...
        debugLog("   - code: "
                + EHelperUtils.errorCodeToString(mConnectionResult
                .getErrorCode()));
    ...
    void giveUp(SignInFailureReason reason) {
        ...
        if (reason.mActivityResultCode == GamesActivityResultCodes.RESULT_APP_MISCONFIGURED) {
            ...
            EHelperUtils.printMisconfiguredDebugInfo(mAppContext);
        }
    ...
    public static void showFailureDialog(Activity activity, int actResp,
        ...
        switch (actResp) {
            case GamesActivityResultCodes.RESULT_APP_MISCONFIGURED:
                errorDialog = makeSimpleDialog(activity, EHelperUtils.getString(
                        activity, EHelperUtils.R_APP_MISCONFIGURED));
                break;
            case GamesActivityResultCodes.RESULT_SIGN_IN_FAILED:
                errorDialog = makeSimpleDialog(activity, EHelperUtils.getString(
                        activity, EHelperUtils.R_SIGN_IN_FAILED));
                break;
            case GamesActivityResultCodes.RESULT_LICENSE_FAILED:
                errorDialog = makeSimpleDialog(activity, EHelperUtils.getString(
                        activity, EHelperUtils.R_LICENSE_FAILED));
                break;
            default:
                ...
                if (errorDialog == null) {
                    ...
                    errorDialog = makeSimpleDialog(
                            activity,
                            EHelperUtils.getString(activity,
                                    EHelperUtils.R_UNKNOWN_ERROR)
                                    + " "
                                    + EHelperUtils.errorCodeToString(errorCode));
                }
        }
    ...
    public static class SignInFailureReason {
        ...
        public String toString() {
            return "SignInFailureReason(serviceErrorCode:"
                    + EHelperUtils.errorCodeToString(mServiceErrorCode)
