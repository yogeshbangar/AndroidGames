...
public abstract class BaseGameActivity extends FragmentActivity implements
        DHelper.GameHelperListener {

    // The game helper object. This class is mainly a wrapper around this object.
    protected DHelper mHelper;

    // We expose these constants here because we don't want users of this class
    // to have to know about GameHelper at all.
    public static final int CLIENT_GAMES = DHelper.CLIENT_GAMES;
    public static final int CLIENT_APPSTATE = DHelper.CLIENT_APPSTATE;
    public static final int CLIENT_PLUS = DHelper.CLIENT_PLUS;
    public static final int CLIENT_ALL = DHelper.CLIENT_ALL;
    ...
    public DHelper getGameHelper() {
        if (mHelper == null) {
            mHelper = new DHelper(this, mRequestedClients);
    ...
    protected DHelper.SignInFailureReason getSignInError() {
