...
public class Object3D extends ATransformable3D implements Comparable<Object3D>, INode {
	...
	protected boolean mIsVisible = false;///MyChange
	...
	protected boolean mRenderChildrenAsBatch = false;//MyChange
...
//		setBlendFunc(GLES20.GL_ONE, GLES20.GL_ONE);//My Change
	...
	public void unsetMaterial(Material material) {
		if(material == null) return;
		MaterialManager.getInstance().removeMaterial(material);
	}
...
//	{
//		return Math.abs((mGeometry.mVertices.get(0))/2);
//	}
//	public float getHeight()
//	{
//		return Math.abs((mGeometry.mVertices.get(1))/2);
//	}
	public float getHeight()
    {
		float h = mBitmap.getHeight()*2;
	    return(h/RajawaliActivity.mMaxY);
    }
	public float getWidth()
    {
		float w = mBitmap.getWidth()*2; 
	  return(w/RajawaliActivity.mMaxX);
    }
