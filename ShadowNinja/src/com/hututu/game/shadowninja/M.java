...
public class M 
{
	public static final int ACHIV[] = {
		  R.string.achievement_brave_ninja,
		  R.string.achievement_daredevil_ninja,
		  R.string.achievement_enthusiastic_ninja,
		  R.string.achievement_adventurous_ninja,
		  R.string.achievement_kill_shadow_ninja
	};
...
//	
	...
	public static final int GAMEPAUS = 1;
