...
public class M 
{
	...
	public static final int ACHIV[] = {
		  R.string.achievement_classic_jumper,
		  R.string.achievement_sharp_jumper,
		  R.string.achievement_exalted_jumper,
		  R.string.achievement_master_jumper,
		  R.string.achievement_king_jumper
	};
	...
	public static final int GAMEPOWER = 6;
...
//					sound4(context,R.drawable.g4);
	...
	static void Tap(Context context){
		switch (M.mRand.nextInt(7)) {
		case 1:
			sound9(context, R.drawable.ninja_tap1);
			break;
		case 2:
			sound10(context, R.drawable.ninja_tap2);
			break;
		case 3:
			sound11(context, R.drawable.ninja_tap3);
			break;
		case 4:
			sound12(context, R.drawable.ninja_tap4);
			break;
		case 5:
			sound13(context, R.drawable.ninja_tap5);
			break;
		case 6:
			sound14(context, R.drawable.ninja_tap6);
			break;
		default:
			sound15(context, R.drawable.ninja_tap0);
			break;
		}
	}
	
	static void impact(Context context){
		switch (M.mRand.nextInt(4)) {
		case 1:
			sound16(context, R.drawable.impact1);
			break;
		case 2:
			sound17(context, R.drawable.impact2);
			break;
		case 3:
			sound18(context, R.drawable.impcat3);
			break;
		default:
			sound19(context, R.drawable.impact0);
			break;
		}
	}
